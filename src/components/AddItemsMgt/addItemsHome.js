    ...
    try {
      ...
      for (const item of filteredItems) {
        const itemData = [
          ...
          `LKR ${(parseFloat(item.price || 0) * parseInt(item.quantity || 0)).toFixed(2)}`
        ];
      ...
      doc.autoTable({
        ...
        columnStyles: {
          0: { // Item name (was index 1)
            cellWidth: 40,
          },
          1: { // Description (was index 2)
            cellWidth: 50,
          },
          2: { // Date (was index 3)
            cellWidth: 25,
                  ...
                  {filteredItems.length === 0 ? (
                      ...
                      <td colSpan="7" className="px-6 py-10 text-center text-gray-500">
                        <div className="flex flex-col items-center justify-center">
                          ...
                          {searchQuery ? (
                            ...
                            <p className="text-lg font-medium">No items available. Add your first item!</p>
                          )}
                        </div>
                      </td>
                    </tr>
                    ...
                    filteredItems.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-600">{item.date || "N/A"}</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
